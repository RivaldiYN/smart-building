...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('assets/itera.jpg') }}" alt="AdminLTELogo" width="60">
  </div>
  ...
  <aside class="main-sidebar elevation-4" style="background-color: #28a745;">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-normal small text-white">Smart Building ITERA</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('assets/default.png') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <footer class="main-footer fixed-bottom">
    <strong>Copyright &copy; 2024 <a href="#">Smart Building ITERA</a>.</strong>
    All rights reserved.
  </footer>
